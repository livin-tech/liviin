...
import { MeasureTapeIcon } from '../../../assets/icons/MeasureTapeIcon';
...
export function Step1({ navigation }) {
  return (
    <ScreenLayout headerTitle="Your property is...">
      ...
      <Subheading>Answer the following questions and then proceed the next question</Subheading>
      <Card style={styles.card}>
        <Card.Content>
          <Subheading>Is this a house or apartment?</Subheading>
        </Card.Content>
      </Card>
      <QuestionItem.ItemTextInput theme={theme} label="Name" placeholder="e.g beach house"  />
      <QuestionItem.Item
        icon={MeasureTapeIcon}
        text="How many MTs"
      />
      <QuestionItem.Item
        icon={BedIcon}
      ...
      <QuestionItem.Item
        ...
        text="Bathrooms"
      />
      <Button mode="contained" style={styles.submitButton} onPress={() => navigation.navigate('Step2')}>Next</Button>
    </ScreenLayout>
  )
}
